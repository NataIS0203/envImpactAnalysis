...
namespace Durable.Functions
{
    ...
    {
        private readonly ILogger<DurableFunction> _logger;
        public DurableFunction(ILogger<DurableFunction> logger)
        {
            _logger = logger;
        }
        ...
        [Function("NewTriggered")]
        public IActionResult Run([HttpTrigger(AuthorizationLevel.Function, "get", Route = "export/neighbors")] HttpRequest req)
        {
